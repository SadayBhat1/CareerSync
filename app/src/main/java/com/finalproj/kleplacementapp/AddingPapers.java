...
public class AddingPapers extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i= new Intent(AddingPapers.this,AdminHome.class);
        startActivity(i);
    }
    ...
    public void AddPdf(View view) {
        ...
        if (paperUri == null && title.isEmpty()) {
            // Both file and title are empty, display the message
            Toast.makeText(AddingPapers.this, "All fields required", Toast.LENGTH_SHORT).show();
        } else if (paperUri != null) {
            // File is chosen, proceed with upload
            ...
            reference.putFile(paperUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            uploadPDF uploadPDF = new uploadPDF(title, url.toString());
            ...
            // File is not chosen, but title is provided
            Toast.makeText(AddingPapers.this, "Please choose a file", Toast.LENGTH_SHORT).show();
        }
    }
